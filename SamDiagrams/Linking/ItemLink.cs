...
{
    public partial class ItemLink:IComparable, IDrawableItem
    {
        ...
        public Rectangle Bounds
        {
            get
            {
                Rectangle r = new Rectangle(Math.Min(sourcePoint.X, destinationPoint.X), Math.Min(sourcePoint.Y, destinationPoint.Y), Math.Abs(sourcePoint.X - destinationPoint.X), Math.Abs(sourcePoint.Y - destinationPoint.Y));
                return r;
            }
        }
        ...
        public ItemLink(DiagramItem source, DiagramItem destination)
        {
            this.source = source;
        ...
        public ItemLink(DiagramItem source, DiagramItem destination, Color color):this(source,destination)
        {
            this.color = color;
        }
